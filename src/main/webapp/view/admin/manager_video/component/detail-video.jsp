                            ...
                            <div class="card">
                                <div class="card-body">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="title" name="title" value="${video.title}" readonly>
                                        </div>
                                        <div class="mb-3">
                                            <label for="description" class="form-label">Description</label>
                                            <input type="text" class="form-control" id="description" name="description" value="${video.description}" readonly>
                                        </div>
                                        <div class="mb-3">
                                        ...
                                        <div class="mb-3">
                                            <img style="height: 160px;width: 265px;border-radius: 5px 5px 5px 5px;"
                                                 src="${pageContext.request.contextPath}/img/${video.poster}" id="imageLoad" />
                                        </div>
                                        <div class="mb-3">
                                            <label for="active" class="form-label">Status</label>
                                            <select id="active" name="active" class="form-select" aria-label="Default select example" disabled>
                                        ...
                                        <a href="${pageContext.request.contextPath}/manager-video"><button type="submit" class="btn btn-success">Quay Lại</button></a>
                                </div>
                            </div>
                        </div>
                    </div>
