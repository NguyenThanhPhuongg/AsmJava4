           ...
           <div class="row">
             <h1>Add Video</h1>
              <div class="col-6  d-flex justify-content-center align-items-center">
                  <div class="card">
                     <div class="card-body ">
                         <video id="uploadedVideo" width="632px" src="${pageContext.request.contextPath}/view/videoupload/nhac.mp4" type="video/mp4" autoplay controls></video>
                     </div>
                  </div>
              </div>
             <div class="col-6">
               <div class="card">
                 <div class="card-body">
                     <form action="${pageContext.request.contextPath}/add-video" method="post" enctype="multipart/form-data">
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                          <label for="urlImage" class="form-label">Poster</label>
                          <input onchange="displayImage(this)" id="urlImage" type="file" class="form-control"  name="poster">
                        </div>
                         <div class="mb-3">
