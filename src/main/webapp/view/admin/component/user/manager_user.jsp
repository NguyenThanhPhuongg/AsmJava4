    ...
    <div class="main">
        ...
        <main class="content px-3 py-4">
            <div class="container-fluid">
                <%--content--%>
                <div class="mb-3">
                    <h3 class="fw-bold fs-4 my-3">Manager User</h3>
                    <div class="row">
                        <div class="col-12">
                           <a href="${pageContext.request.contextPath}/add-user">  <button type="button" class="btn btn-success">Add user</button></a>
                            <table class="table table-striped">
                                ...
                                <c:forEach items="${listUser}" var="item" >
                                    <tr>
                                        ...
                                        <td style="vertical-align: middle;">${item.admin ? 'Admin' : 'User'}</td>
                                        <td style="vertical-align: middle;">
                                            <a href="${pageContext.request.contextPath}/update-user?id=${item.id}" style="text-decoration: none;">
                                                <button type="button" class="btn btn-warning">Update</button>
                                            </a>
                                            <a href="#" onclick="handleDelete('${pageContext.request.contextPath}/manager-user?action=delete&id=${item.id}')" style="text-decoration: none;">
...
<script>
    function handleDelete(url) {
        let result = window.confirm("Are you sure you want to delete user?");
        if (result) {
